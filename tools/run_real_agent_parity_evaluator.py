...
REAL_COMMANDS = {
    ...
    "opencode": [
        sys.executable,
        "tools/run_real_opencode_deepseek_mcp_parity.py",
        "--all",
        "--require-real",
        "--report",
    ],
    "openclaw": [
        sys.executable,
        "tools/run_real_openclaw_deepseek_mcp_parity.py",
        "--all",
        "--require-real",
        "--report",
    ],
...
CLAIM_ROWS = (
    (
        ...
        "python tools/run_real_environment_validation.py --all --require-real --fail-if-gate-missing --report",
    ...
    (
        ...
        "python tools/run_real_opencode_deepseek_mcp_parity.py --all --require-real --report",
    ...
    (
        ...
        "python tools/run_real_openclaw_deepseek_mcp_parity.py --all --require-real --report",
    ...
    (
        ...
        "python tools/run_agent_parity_matrix.py --report",
        "47e66f0877aec0bf06b45f930ca0cb36fcb1ef9c",
...
def run_fresh(selected: Sequence[str], env: Mapping[str, str]) -> list[dict[str, Any]]:
    ...
    if all(result["returncode"] == 0 for result in results):
        results.append(run_command("agent_parity_matrix", [sys.executable, "tools/run_agent_parity_matrix.py", "--report"], env=env))
    return results
