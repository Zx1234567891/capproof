...
CAPROOF_MCP_COMMAND = ("python", "tools/run_capproof_mcp_server.py", "--stdio", "--sandboxed-real-execution")
TIMEOUT_SECONDS = 8
...
def matrix_rows(summary: RuntimeGateSummary) -> list[dict[str, Any]]:
    return [
        ...
        {"item": "shared_capproof_mcp_server", "passed": summary.uses_shared_capproof_mcp_server and not summary.forked_guard_logic, "evidence": "single tools/run_capproof_mcp_server.py command reused"},
