...
REAL_COMMANDS = (
    (
        ...
        [
            sys.executable,
            "run_real_hermes_foreground_mcp_demo.py",
            "--all",
            "--foreground",
            "--task",
            "list_capproof_tools",
    ...
    ("sandbox", [sys.executable, "run_real_hermes_sandbox_mcp_smoke.py", "--all"]),
    ("ask", [sys.executable, "run_real_hermes_foreground_ask_flow.py", "--all", "--foreground"]),
)
